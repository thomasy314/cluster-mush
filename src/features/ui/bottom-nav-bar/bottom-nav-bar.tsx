        ...
        <footer>
            ...
            <Container maxWidth={false} sx={{ backgroundColor: 'secondary.main', paddingBottom: '3vh', paddingTop: '3vh' }}>
                <Grid justifyContent='center' textAlign='center' container>
                    <Grid classes="bottomNavBarSection" item xs={12} md={4} display='flex' justifyContent='center' alignItems='center'>
                        <div>
                            ...
                            <Link color='primary.light' underline="hover" href={completeShopUrl} sx={{ padding: '.5rem' }}>Shop</Link>
                        </div>
                    </Grid>
