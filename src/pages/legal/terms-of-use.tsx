...
export const TermsOfUse = () => {
    return (
        <Container className="legalContainer">
            ...
            <p>
                You can contact us by email at support@clustermush.com
            </p>
            <p>
                These Legal Terms constitute a legally binding agreement made between
                you, whether personally or on behalf of an entity ("<b>you</b>"), and Cluster
                Mush, concerning your access to and use of the Services. You agree that
            ...
            <ol>
                ...
                <li><Link href="#6-purchases-and-payment">PURCHASES AND PAYMENT</Link></li>
                <li><Link href="#7-return-policy">RETURN POLICY</Link></li>
                <li><Link href="#8-prohibited-activities">PROHIBITED ACTIVITIES</Link></li>
                <li><Link href="#9-user-generated-contributions">USER GENERATED CONTRIBUTIONS</Link></li>
                <li><Link href="#10-contribution-license">CONTRIBUTION LICENSE</Link></li>
                <li><Link href="#11-social-media">SOCIAL MEDIA</Link></li>
                <li><Link href="#12-third-party-websites-and-content">THIRD-PARTY WEBSITES AND CONTENT</Link></li>
                <li><Link href="#13-services-management">SERVICES MANAGEMENT</Link></li>
                <li><Link href="#14-privacy-policy">PRIVACY POLICY</Link></li>
                <li><Link href="#15-term-and-termination">TERM AND TERMINATION</Link></li>
                <li><Link href="#16-modifications-and-interruptions">MODIFICATIONS AND INTERRUPTIONS</Link></li>
                <li><Link href="#17-governing-law">GOVERNING LAW</Link></li>
                <li><Link href="#18-dispute-resolution">DISPUTE RESOLUTION</Link></li>
                <li><Link href="#19-corrections">CORRECTIONS</Link></li>
                <li><Link href="#20-disclaimer">DISCLAIMER</Link></li>
                <li><Link href="#21-limitations-of-liability">LIMITATIONS OF LIABILITY</Link></li>
                <li><Link href="#22-indemnification">INDEMNIFICATION</Link></li>
                <li><Link href="#23-user-data">USER DATA</Link></li>
                <li><Link href="#24-electronic-communications-transactions-and-signatures">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNITURES</Link></li>
                <li><Link href="#25-california-users-and-residents">CALIFORNIA USERS AND RESIDENTS</Link></li>
                <li><Link href="#26-miscellaneous">MISCELLANEOUS</Link></li>
                <li><Link href="#27-contact-us">CONTACT US</Link></li>
            </ol>
            <div id="1-our-services">
            ...
            <div id="2-intellectual-property-rights">
                ...
                <p>
                    ...
                    "<Link href="#8-prohibited-activities">PROHIBITED ACTIVITIES</Link>" section below, we grant you a non-exclusive,
                ...
                <p>
                    ...
                    your request to: support@clustermush.com. If we ever grant you the
                ...
                <p>
                    Please review this section and the "<Link href="#8-prohibited-activities">PROHIBITED ACTIVITIES</Link>" section
                ...
                <ul>
                    <li>
                        confirm that you have read and agree with our "<Link href="#8-prohibited-activities">PROHIBITED ACTIVITIES</Link>" and will not post, send, publish, upload, or transmit
                    ...
                    <li>
                        ...
                        Submissions and that you have full authority to grant us the abovementioned rights in relation to your Submissions; and
                    </li>
                    <li>
            ...
            <div id="3-user-representations">
                ...
                <p>
                    ...
                    unauthorized purpose; and (7) your use of the Services will not violate
            ...
            <div id="5-products">
                <SectionTitle>5. PRODUCTS</SectionTitle>
                <p>
            ...
            <div id="6-purchases-and-payment">
            ...
            <div id="8-prohibited-activities">
                <SectionTitle>8. PROHIBITED ACTIVITES</SectionTitle>
                <p>
            ...
            <div id="9-user-generated-contributions">
                ...
                <p>
                    ...
                    with the Services' Privacy Policy. When you create or make available any
            ...
            <div id="10-contribution-license">
                <SectionTitle>10. CONTRIBUTAION LICENSE</SectionTitle>
                <p>
                    ...
                    <Link href="/privacy-policy">Privacy Policy</Link> and your choices (including settings).
                </p>
                <p>
            ...
            <div id="11-social-media">
                <SectionTitle>11. SOCIAL MEDIA</SectionTitle>
                <p>
                    ...
                    You represent and warrant that you are entitled to disclose your ThirdParty Account login information to us and/or grant us access to your
                    ...
                    usage limitations imposed by the third-party service provider of the ThirdParty Account. By granting us access to any Third-Party Accounts, you
                    ...
                    any friend lists and (2) we may submit to and receive from your ThirdParty Account additional information to the extent you are notified when
                    ...
                    on and through your account on the Services. Please note that if a ThirdParty Account or associated service becomes unavailable or our access
                    ...
                    through the Services. You will have the ability to disable the connection
            ...
            <div id="12-third-party-websites-and-content">
                <SectionTitle>12. THIRD-PARTY WEBSITES AND CONTENT</SectionTitle>
                <p>
                    ...
                    Inclusion of, linking to, or permitting the use or installation of any ThirdParty Websites or any Third-Party Content does not imply approval or
            ...
            <div id="13-services-management">
                <SectionTitle>13. SERVICES MANAGEMENT</SectionTitle>
                <p>
            ...
            <div id="14-privacy-policy">
                <SectionTitle>14. PRIVACY POLICY</SectionTitle>
                <p>
                    We care about data privacy and security. Please review our <Link href="/privacy-policy">Privacy
                        Policy</ Link>. By using the Services,
            ...
            <div id="15-term-and-termination">
                <SectionTitle>15. TERM AND TERMINATION</SectionTitle>
                <p>
            ...
            <div id="16-modifications-and-interruptions">
                <SectionTitle>16. MODIFICATIONS AND INTERRUPTIONS</SectionTitle>
                <p>
            ...
            <div id="18-dispute-resolution">
                <SectionTitle>18. DISPUTE RESOLUTION</SectionTitle>
            ...
            <div id="19-corrections">
                <SectionTitle>19. CORRECTIONS</SectionTitle>
                <p>
                    There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
                </p>
            </div>
            <div id="20-disclaimer">
                <SectionTitle>20. DISCLAIMER</SectionTitle>
                <p>
            ...
            <div id="21-limitations-of-liability">
                <SectionTitle>21. LIMITATIONS OF LIABILITY</SectionTitle>
                <p>
            ...
            <div id="22-indemnification">
                <SectionTitle>22. INDEMNIFICATION</SectionTitle>
                <p>
            ...
            <div id="23-user-data">
                <SectionTitle>23. USER DATA</SectionTitle>
                <p>
                    We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
                </p>
            </div>
            <div id="24-electronic-communications-transactions-and-signatures">
                <SectionTitle>24. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</SectionTitle>
                <p>
            ...
            <div id="25-california-users-and-residents">
                <SectionTitle>25. CALIFORNIA USERS AND RESIDENTS</SectionTitle>
                <p>
                    If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.
                </p>
            </div>
            <div id="26-miscellaneous">
                <SectionTitle>26. MISCELLANEOUS</SectionTitle>
                <p>
            ...
            <div id="27-contact-us">
                <SectionTitle>27. CONTACT US</SectionTitle>
                <p>
                In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at <b>support@clustermush.com</b> or on our <Link href="/contact">contact us page</Link>.
                </p>
            </div>
