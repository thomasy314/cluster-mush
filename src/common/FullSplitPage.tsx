...
type FullSplitPageProps = {
    titleComponent: JSX.Element,
    imageSrc: string,
    smallImage?: boolean
}

const FullSplitPageDefaultProps = {
    smallImage: false
}

const FullSplitPage = (props: PropsWithChildren<FullSplitPageProps>) => {
...
FullSplitPage.defaultProps = FullSplitPageDefaultProps;
